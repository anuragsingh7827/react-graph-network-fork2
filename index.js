...
var Graph = function Graph(_ref) {
  ...
  (0, _react.useEffect)(function () {
    ...
    ).force("charge", (0, _d3Force.forceManyBody)().distanceMax(400).strength(-50)) // This adds repulsion between nodes. Play with the -400 for the repulsion strength
    .force("x", (0, _d3Force.forceX()))
    .force("y", (0, _d3Force.forceY()))
    .on("tick", function () {
